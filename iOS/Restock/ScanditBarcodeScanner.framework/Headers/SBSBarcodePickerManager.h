 ...
 *
 * Alternatively to directly allocate a SBSBarcodePicker you can use and SBSBarcodePickerManager to
 * get a SBSBarcodePicker instance. By using the manager it is possible to allocate a picker when
 ...
 *
 * Be aware that since the manager caches the running camera to be able to remove the delay that
 * would be needed to start the camera this will lead to increased battery usage.
 */
 ...
 *
 * It is generally not a good idea to set this to 0 seconds as there may times (for example when
 ...
 */
- (void)registerNeedByObject:(id)anObject;
 ...
 */
- (void)unregisterNeedByObject:(id)anObject;
 ...
 */
- (void)requestPickerForObject:(id)anObject
              withScanSettings:(SBSScanSettings *)settings
                  successBlock:(void(^)(SBSBarcodePicker *picker))requestBlock;
 ...
 */
- (void)releasePickerForObject:(id)anObject;
 ...
 */
- (void)freezePickerForObject:(id)anObject;
 ...
 */
- (void)unfreezePickerForObject:(id)anObject;

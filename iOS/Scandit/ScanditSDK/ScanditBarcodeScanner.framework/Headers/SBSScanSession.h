...
/**
 * \brief Interface for a scan session
 *
...
/**
 * \brief A new copy of the list of barcodes that have been successfully
 *    decoded in the last frame.
 */
@property (readonly, nonatomic, copy) NSArray* newlyRecognizedCodes;

/**
 * \brief A new copy of the list of barcodes that have been localized but not
 * recognized in the last frame.
 */
@property (readonly, nonatomic, copy) NSArray* newlyLocalizedCodes;
 ...
 */
@property (readonly, nonatomic, copy) NSArray* allRecognizedCodes;
